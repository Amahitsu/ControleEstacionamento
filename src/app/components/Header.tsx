    ...
    return (
        <div className={styles.header}>
            ...
            <ul className={styles.menu}>
                <li className="text-teal-600 mr-6 underline decoration-1"><a href="/pages/cadastrarPlaca">Placas</a></li>
                ...
                <li className="text-teal-600 underline decoration-1"><a href="/pages/cadastrarTarifa">Tarifas</a></li>
            </ul>
